...
export default function AssignmentEditor() {
  ...
  const [description, setDescription] = useState(assignment ? assignment.description : "New Description");
  const [points, setPoints] = useState(assignment ? assignment.points : 100);
  const [dueDate, setDueDate] = useState(assignment ? assignment.dueDate : "2023-12-15");
  const [availableDate, setAvailableDate] = useState(assignment ? assignment.availableDate : "2023-09-10");
  ...
  return (
    <div id="wd-assignments-editor">
      ...
      <div className="mb-3">
        <textarea className="form-control" id="wd-description" rows={4} onChange={(e) => setDescription(e.target.value)} value={description} />
      </div>
      <div className="row mb-3">
        <label htmlFor="wd-points" className="col-sm-2 col-col-sm-2 col-form-label text-end">Points</label>
        <div className="col-sm-10">
          <input type="number" className="form-control" id="wd-points" onChange={(e) => setPoints(parseFloat(e.target.value))} value={points} />
        </div>
      </div>
      <div className="row mb-3">
      ...
      <div className="row mb-3">
        ...
        <div className="col-sm-10">
          <div className="border p-3">
            ...
            <input type="date" className="form-control" id="wd-available-from" onChange={(e) => setAvailableDate(e.target.value)} value={availableDate} />
